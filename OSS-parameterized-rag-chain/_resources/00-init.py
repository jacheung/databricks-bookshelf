...
# replaced .config with .rag_chain_config.yaml that could be used in chain and driver notebooks
import mlflow
model_config = mlflow.models.ModelConfig(development_config='../rag_chain_config.yaml')

VECTOR_SEARCH_ENDPOINT_NAME= model_config.get('vector_search_endpoint_name')
DATABRICKS_SITEMAP_URL = model_config.get('DATABRICKS_SITEMAP_URL')
catalog = model_config.get('catalog')
dbName = db = model_config.get('db')
