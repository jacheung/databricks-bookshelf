...
# ``abundant_forecasting/resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-abundant_forecasting-experiment",
    label="MLflow experiment name",
)
# Unity Catalog registered model name to use for the trained model.
dbutils.widgets.text(
    "model_name", "dev.abundant_forecasting.abundant_forecasting-model", label="Full (Three-Level) Model Name"
)
