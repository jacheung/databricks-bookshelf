# Batch Inference
To set up batch inference job via scheduled Databricks workflow, please refer to [abundant_forecasting/resources/README.md](../../resources/README.md)
...
df.write.mode("overwrite").saveAsTable(
    name="<catalog>.abundant_forecasting.feature_store_inference_input"
)
```
